...
fun main() {
//    println(Day01.part1(readLinesFromFile("day01.txt").first()))
//    println(Day01.part2(readLinesFromFile("day01.txt").first()))
//    println(Day02.part1(readLinesFromFile("day02.txt")))
//    println(Day02.part2(readLinesFromFile("day02.txt")))
//    println(Day03.part1(312051L))
//    println(Day03.part2(312051L))
...
//    println(Day10.part1(readLinesFromFile("day10.txt").first().split(',')))
//    println(Day10.part2(readLinesFromFile("day10.txt").first().map { it.toString() }))
//    println(Day11.part1(readLinesFromFile("day11.txt").first()))
//    println(Day11.part2(readLinesFromFile("day11.txt").first()))
...
//    println(Day14.part1("ffayrhll"))
//    println(Day14.part2("ffayrhll"))
//    println(Day15.part1(readLinesFromFile("day15.txt")))
//    println(Day15.part2(readLinesFromFile("day15.txt")))
//    println(Day16.part1(readLinesFromFile("day16.txt").first().split(',')))
//    println(Day16.part2(readLinesFromFile("day16.txt").first().split(',')))
//    println(Day17.part1(367))
//    println(Day17.part2(367))
