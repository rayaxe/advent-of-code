...
//    println(day06Part1(readAndSplitByEmptyLines("day06.txt")))
//    println(day06Part2(readAndSplitByEmptyLines("day06.txt")))
...
//    println(day09Part1(readLinesFromFile("day09.txt"), 25))
//    println(day09Part2(readLinesFromFile("day09.txt"), 375054920))
...
//    println(day15Part1("5,1,9,18,13,8,0"))
//    println(day15Part2("5,1,9,18,13,8,0"))
...
//    println(day23Part1("284573961"))
//    println(day23Part2("284573961"))
//    println(day24Part1(readLinesFromFile("day24.txt")))
//    println(day24Part2(readLinesFromFile("day24.txt")))
//    println(day25Part1(readText("day25.txt")))
}

private fun readLinesFromFile(filename: String) = File("src//main//resources//v2020//$filename")
    .readLines()

private fun readText(filename: String) = File("src//main//resources//v2020//$filename")
    .readText(Charset.forName("UTF-8"))

private fun readAndSplitByEmptyLines(filename: String) = File("src//main//resources//v2020//$filename")
    .readText(Charset.forName("UTF-8"))
    .split("\n\n")
    .map { it.split("\n") }
